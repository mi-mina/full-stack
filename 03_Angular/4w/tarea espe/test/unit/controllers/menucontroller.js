describe('Controller: MenuController', function () {
  ...
  //A way to specify in Jasmine what needs to be set up before the test is return
  //This is a mock od confusionApp, so that MenuController can be tested.
  beforeEach(module('confusionApp'));

  var MenuController, scope, $httpBackend;
  //$httpBackend is for doing the mock
